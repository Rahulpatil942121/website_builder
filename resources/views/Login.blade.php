...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('/')}}" class="text-white"><b>User Login</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card" style="background: #82717273!important;color:#fcf9f5!important;">
    <div class="card-body login-card-body" style="background: #82717273!important;color:#fcf9f5!important;">
      <p class="login-box-msg">Sign in to start your session</p>

      <form action="{{url('Submit-Login')}}" method="post">
        @csrf
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="login_id" autocomplete="off" placeholder="Email" required="">
