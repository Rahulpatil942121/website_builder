            ...
            <div class="card1">
              <div class="card-body">
                ...
                @foreach($Contain as $list)                 
                  <span class="btn btn-primary mt-1 {{$list->contain->class_name}}" data-toggle="modal" data-target="#{{$list->contain->class_name}}" >{{$list->contain->contain_name}}</span>
              @endforeach
              </div>
            </div>
          </div> 
          <div class="col-md-5 mb-3">
            ...
            <!--    <div class="row d-flex align-items-stretch">                   -->
                  <div class="col-12 d-flex align-items-stretch" >
                    <div class="card bg-light m-auto w-100" style="height: 350px;position: relative;">
                  ...
                  @endphp
                      <div class="d-flex w-100 justify-content-center" style="position: absolute;top: 85%;">
                        <a href="https://duticorptech.prismoptical.in/index/{{$web_template}}" class="btn btn-sm bg-teal mr-1" target="_blank">
                          ...
                          @endphp
                          @if($Exist_Contain)
                            <a href="{{url('/My-Website-Info')}}/{{$template_id}}" class="btn btn-success btn-sm">Edit Website</a>
                            @else
