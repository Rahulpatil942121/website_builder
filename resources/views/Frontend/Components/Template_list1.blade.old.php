...
<section class="content">
          ...
          <div class="row d-flex align-items-stretch">
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch" style="position: relative;">
              <div class="card bg-light" style="height: 300px;">
                ...
                <iframe src="https://duticorptech.prismoptical.in/index/{{$list->temp_name}}" title="" style="height: inherit;"></iframe>
    ...
    <!-- <div class="card card-solid" style="background: #e5f5fc;">
        <div class="card-body pb-0">
            <div class="d-flex h5">Selected Templates</div>
          <div class="row d-flex align-items-stretch">
            @ foreach($ client_template as $ list)
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch" style="position: relative;">
              <div class="card bg-light" style="height: 300px;">
                 <a href="{ {url('/Template-Data')} } /{ {$ list->id} }" style="height: 100%;">
                <iframe src="https://duticorptech.prismoptical.in/index/{ {$ list->domain_name} }" title="" style="height: inherit;"></iframe>
              ...
              <div class="w-100" style="position: absolute;top: 83%;left: 15px;">
                  <a href="{ {url('/Template-Data')} }/{ { $ list->template->id} }" class="btn btn-sm bg-teal">
                    ...
                    <a href="https://duticorptech.prismoptical.in/index/{ {$ list->domain_name} }" class="btn btn-sm btn-primary" target="_blank">
                      <i class="nav-icon fas fa-th"></i> View Template
                    </a>
              </div>
            </div>
