...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('Frontend/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url('/Home')}}" class="nav-link @if($flag == 1) active @endif">
          ...
          <!-- <li class="nav-item has-treeview @ if($ inline == 1)menu-open @ endif">
            <a href="#" class="nav-link @ if($inline == 1) active @ endif">
            ...
            <!-- <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{ {url('/Template-List1')} }" class="nav-link @ if($ flag == 2) active @ endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Template List</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link @ if($ flag == 3) active @ endif">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Template</p>
                </a>
              </li>
          ...
          <!-- </li> -->
          <li class="nav-item">
            <a href="{{url('/My-Template')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                My Template
