                        ...
                        <div class="box-body">
                            <div class="col-md-3">
                                <div class="form-group">                                 
                                    ...
                                    <input type="text" name="template_name" value="{{old('template_name')}}" autocomplete="off" placeholder="Enter Template Name" class="form-control" required="">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">                                 
                                    ...
                                    <input type="text" name="temp_folder_name" value="{{old('temp_folder_name')}}" autocomplete="off" placeholder="Enter Folder Name(No Any Space)" class="form-control" required="">
                            ...
                            <div class="col-md-12">
                                ...
                                @if($Contain)
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">                                 
                                             <label>
                                                <input type="checkbox" name="temp_contain[]" value="{{$list->id}}" class="minimal-red" />
                                                {{$list->contain_name}}
                                            </label>
                                        </div> 
                                    </div>
